...
/**This utility class holds all methods and constants for searching in the LuggageList screen.
 *
...
public class LuggageSearchBarLogic {
    ...
    /**This method is called when one of the search events is called.
     * The entry point for full searching.
     * 
     * @param searchString The full String the user entered.
     * @param searchableList The list of Luggages.
     * @param foundMode true if it's a FoundLuggage list, false if it's a LostLuggage list.
     * @return The list that only contains the entries that were not filtered by the search.
     */
    ...
    /**This method understands all specific index numbers and sends the list to the 
     * respective methods.
     * 
     * @param keywordIndex The number representing a specific property. Or -1 if none.
    ...
    public static ArrayList<Luggage> filterList(int keywordIndex, String searchString, ArrayList<Luggage> searchableList){
        ...
        switch (keywordIndex) {
        case -1: searchableList = simpleSearch(searchableList, searchString);
            break;
        case 0: searchableList = checkDate(searchableList, searchString);
            break;
        case 1: searchableList = checkAirport(searchableList, searchString);
            break;
        case 2: searchableList = checkLAFID(searchableList, searchString);
            break;
        case 3: searchableList = checkLuggageID(searchableList, searchString);
            break;
        case 4: searchableList = checkStatus(searchableList, searchString);
            break;
        case 5: searchableList = checkFlightnumber(searchableList, searchString);
            break;
        case 6: searchableList = checkDestination(searchableList, searchString);
            break;
        case 7: searchableList = checkType(searchableList, searchString);
            break;
        case 8: searchableList = checkBrand(searchableList, searchString);
            break;
        case 9: searchableList = checkColor(searchableList, searchString);
            break;
        case 10: searchableList = checkFeatures(searchableList, searchString);
            break;
        case 11: 
            break;
        case 12: 
     ...
     * keyword for a property.
     * This one works only for the input in the FoundLuggage list.
     * 
    ...
    /**This method does not take different properties in account and 'simply' uses 
     * luggage.toString();
     * 
